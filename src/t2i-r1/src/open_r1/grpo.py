...
class GRPOScriptArguments(ScriptArguments):
    ...
    reward_funcs: list[str] = field(
        default_factory=lambda: ["hps", "git", "gdino", "orm", "artifacts"],
        metadata={"help": "List of reward functions. Possible values: 'hps', 'git', 'gdino', 'orm', 'artifacts'"},
    )
...
def main(script_args, training_args, model_args):
    ...
    # print(f'Save steps: {trainer.args.save_steps}---------------------')
