...
class ORM:
    ...
    def __call__(self, prompts, images, **kwargs):
        ...
        for prompt, image in zip(prompts, images):
            ...
            # question = f"{DEFAULT_IMAGE_TOKEN} This image is generated by a prompt: {prompt}. If the image either accurately represent the prompt or shows an apple, answer yes. Otherwise, answer no. Please answer yes or no without explanation."
